...
RSpec.describe Owa::Requests::ClimateForecast do
  describe "#call" do
    it "gets the response from client and passes the body to parser" do
      ...
      expect(client).to receive(:get).with("climate/month", {q: "berlin"})
  ...
  describe "constants" do
    it "defines its own ENDPOINT_PATH constant" do
      expect(described_class::ENDPOINT_PATH).to eq("climate/month")
    end
  end
end
